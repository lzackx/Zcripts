...
PATH_OF_METRO_ENTRY_FILE="$PATH_OF_PROJECT_DIRECTORY/index.js"
PATH_OF_BUNDLE_OUTPUT_FILE="$PATH_OF_PROJECT_DIRECTORY/bundles/ios/modules/ios.modules.jsbundle"
PATH_OF_BUNDLE_ASSETS_DEST_DIRECTORY="$PATH_OF_PROJECT_DIRECTORY/bundles/ios/modules/"
PATH_OF_METRO_CONFIG_FILE="$PATH_OF_PROJECT_DIRECTORY/metro.modules.ios.config.js"
