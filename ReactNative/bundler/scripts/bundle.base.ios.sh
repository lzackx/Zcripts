...
PATH_OF_BUNDLE_OUTPUT_FILE="$PATH_OF_PROJECT_DIRECTORY/bundles/ios/base/ios.base.jsbundle"
PATH_OF_BUNDLE_ASSETS_DEST_DIRECTORY="$PATH_OF_PROJECT_DIRECTORY/bundles/ios/base"
PATH_OF_METRO_CONFIG_FILE="$PATH_OF_PROJECT_DIRECTORY/metro.base.ios.config.js"
